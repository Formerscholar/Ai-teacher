# 2.24 log
```
  1.  修复 老师平台 查看学生的学情报告，知识点错题没有改
  2.  新增 老师平台 校本试卷详情 学情报告
  3.  修复 官网 样式修改
...
# 2.22 log
```
  1.  修复 老师平台 首页试卷夹 链接错误
  2.  修复 老师平台 知识点弹窗加宽
  3.  修复 老师平台 组卷tree 上下册默认显示问题
  4.  修复 小程序 首页角标 默认为0
  5.  修复 老师平台 题目详情，考点不显示，是有数据的
  6.  修复 老师平台 浏览次数改成试卷分类
  7.  修复 老师平台 所有试卷详情 知识点分析字体大小 溢出隐藏 问题
  8.  修复 小程序 选择教辅 上下学期默认问题
...
# 2.8 log
```
  1.  新增 教师平台 学情报告 错题人展示框及数据对接
  2.  新增 教师平台 名校资源 同步至我的试卷工具
  3.  新增 教师平台 名校资源 文件夹功能及子页面
  4.  新增 教师平台 校本试卷 文件夹功能及子页面
  
```

# 2.7 log
```
  1.  新增 教师平台 学生学情报告 知识点分析图+点击切换题目组件及事件
  2.  替换 教师平台 banner图
  3.  新增 教师平台 名校资源 详情页 统计图 + 下载
  4.  新增 教师平台 校本试卷 详情页 统计图 + 下载
  5.  修复 教师平台 我的试卷 同步时间+组卷时间显示问题
  6.  新增 教师品台 已同步试卷则不显示同步按钮
...
```
  1.  新增 教师平台 同步分类 + 同步显示
  2.  新增 教师平台 班级学情报告 知识点分析图
  3.  新增 教师平台 班级学情报告 知识点点击切换题目组件及事件
